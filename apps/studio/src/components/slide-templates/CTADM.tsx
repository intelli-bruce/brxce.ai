...
export function CTADM({ title, keyword, description, prompt, ...colors }: CTADMProps) {
  ...
  return (
    <SlideBase {...colors}>
      ...
      >
        ...
        <MutedText size="lg" mutedColor={colors.mutedColor || '#a3a3a3'} style={{ marginTop: gap['2xl'], fontSize: fontSize.bodySm, lineHeight: lineHeight.relaxed, whiteSpace: 'pre-line' as const }}>
          {description}
        </MutedText>
