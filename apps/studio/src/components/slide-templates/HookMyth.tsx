...
export function HookMyth({ myth, reveal, label, ...colors }: HookMythProps) {
  ...
  return (
    <SlideBase {...colors}>
      ...
      >
        ...
        {/* Divider */}
        <div style={{ width: 60, height: 3, backgroundColor: accent, borderRadius: 2, marginTop: gap['3xl'], marginBottom: gap['3xl'] }} />

        {/* Reveal */}
        <MutedText size="lg" mutedColor={colors.textColor || '#f5f5f5'} style={{ fontSize: fontSize.bodyLg, fontWeight: fontWeight.semibold, lineHeight: lineHeight.relaxed, whiteSpace: 'pre-line' as const }}>
          {reveal}
        </MutedText>
      </div>
    </SlideBase>
